...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[fcfcfc] p-6">
      <h1 className="text-3xl font-bold text-center text-[#3d4243] mb-6">Patient Dashboard</h1>
      <div className="mt-8">
        <h2 className="text-2xl font-semibold text-[#3d4243] mb-4 ">Registered Patients</h2>
        <div className="bg-white rounded-lg shadow-md p-4">
          {patients.length === 0 ? (
            <p className="text-[#3d4243]">No patients registered yet.</p>
          ) : (
