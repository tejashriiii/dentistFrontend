...
const SearchPatients = () => {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto p-4 md:p-6 bg-white shadow-lg rounded-lg mt-4 md:mt-10">
      <h2 className="text-xl md:text-2xl font-bold text-[var(--txt)] mb-3 md:mb-7">
        Search Patients
      </h2>
      <div className="flex flex-col md:flex-row gap-2 md:gap-3">
        <input
          ...
          className="w-full p-2 border border-[var(--lightgreen)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--darkgreen)] mb-2 md:mb-0"
        />
        <input
          type="number"
          placeholder="Enter Phone Number"
        ...
        <button
          onClick={searchPatients}
          className="bg-[var(--darkgreen)] text-white px-4 py-2 rounded-lg hover:bg-[var(--darkergreen)] transition w-full md:w-auto hover:cursor-pointer"
        >
          Search
        </button>
      </div>
            ...
            <table className="min-w-full border-collapse border border-gray-300 shadow-lg rounded-lg overflow-hidden">
              <thead className="bg-[#87ab87] text-white">
                <tr className="text-center">
                  ...
                  <th className="p-2 md:p-3 border text-xs md:text-base">
                    Name
                  </th>
                  <th className="p-2 md:p-3 border text-xs md:text-base">
                    DOB
              ...
              <tbody>
                {patients.map((patient, index) => (
                  ...
                  >
                    ...
                    <td className="p-2 md:p-3 border text-xs md:text-base whitespace-normal break-words">
                      {patient.address}
                    </td>
                  </tr>
                ))}
