...
const PatientDashboard = () => {
    ...
    const fetchPatientData = async () => {
      try {
        ...
        const historyResponse = await fetch(
          `${import.meta.env.VITE_API_URL}/p/history/`,
          {
            headers: {
              Accept: "application/json",
              Authorization: `Bearer ${token}`,
        ...
        if (historyResponse.ok) {
          ...
          filterPendingFollowups(historyData.history);
        }
      } catch (err) {
  ...
  const filterPendingFollowups = (history) => {
    let pendingFollowups = [];
    history.forEach((entry) => {
      const followups = Object.values(entry)[0].followups;
    ...
    setUpcomingFollowups(pendingFollowups);
  };
    ...
    return (
      <div className="min-h-screen flex justify-center items-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="mt-4 text-[var(--txt)] font-medium">
    ...
    return (
      <div className="min-h-screen flex justify-center items-center bg-gray-100">
        <div className="text-center">
          ...
          <Link
            to="/"
            className="mt-4 inline-block px-4 py-2 bg-[var(--darkgreen)] text-white rounded-md"
          >
            Go Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] p-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-[var(--txt)] my-8">
          Patient Dashboard
        </h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h2 className="text-2xl mb-3 font-semibold text-[var(--darkergreen)]">
                {patientInfo.name}
              </h2>
              ...
              <p className="text-gray-600">
                DOB: {formatDate(patientInfo.date_of_birth)}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-[var(--darkergreen)]">
                  Next Follow-up
                </h3>
                <p className="text-gray-600">
                  {upcomingFollowups.length > 0
                    ? formatDate(upcomingFollowups[0].date)
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {patientHistory.length} past visits
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-[var(--darkergreen)] mb-4">
            Medical Details
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h3 className="font-bold text-lg text-[var(--darkergreen)]">
                Allergies
              </h3>
            ...
            <div>
              ...
              {medicalDetails.illnesses &&
                medicalDetails.illnesses.length > 0 ? (
                <ul className="mt-2 pl-2">
            ...
            <div>
              ...
              <div className="mt-2 pl-2">
                <p className="py-1">
                  ...
                  {medicalDetails.smoking ? "Yes" : "No"}
                </p>
                <p className="py-1">
                  <span className="font-semibold">Alcohol:</span>{" "}
                  {medicalDetails.drinking ? "Yes" : "No"}
                </p>
                <p className="py-1">
                  <span className="font-semibold">Tobacco:</span>{" "}
                  {medicalDetails.tobacco ? "Yes" : "No"}
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="pl-5 pt-1 text-sm text-gray-500">
                        Date: {formatDate(complaint_details.date)}
                      </p>
                        ...
                        <ul className="mt-1 space-y-2">
                          {followups.map((followup) => (
                            ...
                            >
                              ...
                              <span
                                className={`text-xs px-2 py-1 rounded-full ${followup.completed === true
